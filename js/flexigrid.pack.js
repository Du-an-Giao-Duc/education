(function($) {
    ...
    $.addFlex = function(t, p) {
        ...
        var g = {hset: {}, rePosDrag: function() {
                ...
                $(g.block).css({height: e, marginBottom: e * -1});
                ...
                if (e == "colresize" && p.colResize === true) {
                    ...
                    this.colresize = {startX: t.pageX, ol: parseInt(n.style.left, 10), ow: i, n: r};
                    ...
                    this.vresize = {h: p.height, sy: t.pageY, w: p.width, sx: t.pageX, hgo: s}
                } else if (e == "colMove") {
                    ...
                    if (p.colMove === true) {
                        ...
                        $(this.colCopy).css({position: "absolute", "float": "left", display: "none", textAlign: n.align});
                ...
                if (p.dataType == "json") {
                    e = $.extend({rows: [], page: 0, total: 0}, e)
                }
                if (p.preProcess) {
                    e = p.preProcess(e)
                }
                ...
                var n = [{name: "page", value: p.newp}, {name: "rp", value: p.rp}, {name: "sortname", value: p.sortname}, {name: "sortorder", value: p.sortorder}, {name: "query", value: p.query}, {name: "qtype", value: p.qtype}];
                if (p.params.length) {
                    for (var r = 0; r < p.params.length; r++) {
                        n[n.length] = p.params[r]
                    }
                }
                $.ajax({type: p.method, url: p.url, data: n, dataType: p.dataType, success: function(e) {
                        g.addData(e)
                ...
                $("tbody tr td", g.bDiv).each(function() {
                    ...
                    if (n != null) {
                        ...
                        $(e).css({textAlign: n.align, width: $("div:first", n)[0].style.width});
                        if (n.hidden) {
                ...
                return{ht: t, wt: r, top: s, left: o, pdl: u, pdt: a, pht: n, pwt: i}
            }, addRowProp: function() {
            ...
            }, combo_flag: true, combo_resetIndex: function(e) {
                if (this.combo_flag) {
                    e.selectedIndex = 0
                }
        ...
        $("thead tr:first th", g.hDiv).each(function() {
            ...
            $(e).css({textAlign: this.align, width: this.width + "px"});
            e.innerHTML = this.innerHTML;
            $(this).empty().append(e).removeAttr("width").mousedown(function(e) {
                ...
                if (g.colCopy) {
                    ...
                    $(g.nDiv).hide();
                    $(g.nBtn).hide();
                    $(g.nBtn).css({left: s, top: g.hDiv.offsetTop}).show();
        ...
        if (p.colResize === true) {
            ...
            if (cdcol !== null) {
                ...
                $("thead tr:first th", g.hDiv).each(function() {
                    ...
                    $(e).css({height: cdheight + hdheight}).mousedown(function(e) {
        ...
        $(r).each(function(e, r) {
            ...
            $.each(r.cells, function(e, t) {
                ...
                if (s == " ")
                    s = "";
                var o = t.cellIndex;
                n.push({Column: r, Value: s, CellIndex: o, RowIdentifier: i})
            });
            t.push(n)
        });
        return t
