...
CKEDITOR.dialog.add('eqneditorDialog', function(editor)
{
    ...
    return {
        ...
        contents: [
            {
                ...
                elements: [
                    ...
                    {
                        type: 'html',
                        html: '<label for="CClatex' + window.CCounter + '">' + editor.lang.eqneditor.equation + ':</label>'
                    },
                    {
                        type: 'html',
                    ...
                    {
                        type: 'html',
                        html: '<label for="CCequation' + window.CCounter + '">' + editor.lang.eqneditor.preview + ':</label>'
                    },
                    {
                        type: 'html',
        ...
        onOk: function() {
            ...
            eqn.setAttribute('class', "codecogs");///
