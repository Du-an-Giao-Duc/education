...
class browser extends uploader {
    ...
    public function __construct() {
        ...
        if (isset($this->get['dir'])) {
            $dir = $this->checkInputDir($this->get['dir'], true, true);
            if ($dir === false) {
                unset($this->get['dir']);
//                $dir = path::normalize($this->get['dir']);
//                if (substr($dir, 0, 1) == "/") {
//                    $dir = substr($dir, 1);
//                }
//                @mkdir("{$this->config['uploadDir']}/$dir", 0775, true);
//                $dir = $this->removeTypeFromPath($dir);
            }
            $this->get['dir'] = $dir;
        }
